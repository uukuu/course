...
\newtcolorbox{mybox}{colback=white,colframe=white,colbacktitle=white,coltitle=black}
...
\newenvironment{theorem}[1][]{
	...
	\begin{tcolorbox}[title = {定理\themytheorem \ifempty{#1}\relax\else.(#1)\fi },colback=SeaGreen!10!CornflowerBlue!10,colframe=RoyalPurple!55!Aquamarine!100!]
}{\end{tcolorbox}}

\newenvironment{lemma}[1][]{
	\refstepcounter{mytheorem}
	\begin{tcolorbox}[title = {引理\themytheorem \ifempty{#1}\relax\else.(#1)\fi },colback=Salmon!20,colframe=Salmon!90!Black]
}{\end{tcolorbox}}


\newenvironment{corollary}[1][]{
	\refstepcounter{mytheorem}
	\begin{tcolorbox}[title = {推论\themytheorem \ifempty{#1}\relax\else.(#1)\fi },colback=Emerald!10,colframe=cyan!40!black]
}{\end{tcolorbox}}

\newenvironment{proposition}[1][]{\refstepcounter{mytheorem}\begin{mybox}\noindent\hspace{\len}\textbf{命题\themytheorem.} \ifempty{#1}\relax\else(#1)\fi
}{\end{mybox}}
